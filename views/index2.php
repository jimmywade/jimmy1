...
<section id="proyectosCreate" style="display:none;">
        ...
        <div id="menuLayout10" class="container" style="display:none; position:fixed; z-index:200; width:100%;">
            <div class="row">
                <div class="col-xs-3 col-xs-offset-8" style="padding:1em; background-color:#fff; box-shadow: 0px 0px 40px #666666;">
                    <div ng-click="proyectoCreate('proyectosCreate','proyectosCreate')" style="width:100%; padding:1em; cursor:pointer; ">Crear proyecto</div><br>
                    <div ng-click="misProyectos('proyectosCreate','misproyecRead')" style="width:100%; padding:1em; cursor:pointer; ">Mis proyectos</div><br>
                    <div ng-click="destruirSesion()" style="width:100%; padding:1em; cursor:pointer; ">Cerrar sesi&oacute;n</div><br>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-2">
                        <button ng-click="proyectoInsert('proyectosCreate','proyectosRead')" style="width:100%;" class="btn btn-primary"><i class="fa fa-check fa-1x" style="text-decoration:none; color:#EBEBEB;" aria-hidden="true"></i></button>
                    </div>
                </div>
            </div>
